    ...
    <section className="py-24 bg-slate-50 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <div className="mb-10">
              <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tight mb-4">About Small Engine Power</h2>
              <p className="text-xl text-slate-600 font-medium leading-relaxed">45 Years of Heritage. 100 Miles of Service. One Lifetime Warranty.</p>
            </div>
