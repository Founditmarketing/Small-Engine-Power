...
import { CheckCircle2, Clock, MessageSquare, RefreshCw } from 'lucide-react';

const CATEGORIES = ['All', 'Mahindra Tractors', 'Ferris Mowers', 'TYM', 'Generators', 'Go-Karts'];
...
const INVENTORY = [
  {
    ...
    price: '$18,500',
    status: 'In-Stock',
    image: '/inventory/mahindra_1626.png',
  ...
  },
  {
    ...
    price: '$14,299',
    status: 'In-Stock',
    image: '/inventory/ferris_isx_3300.png',
  ...
  },
  {
    ...
    price: '$2,399',
    status: 'In-Stock',
    image: '/inventory/honda_generator.png',
    specs: ['3000 Watts', 'Inverter', 'Super Quiet']
  },
  {
    id: 5,
    category: 'Go-Karts',
    name: 'Hammerhead GTS 150',
    price: '$3,899',
    status: 'In-Stock',
    image: '/inventory/hammerhead_gts_150.png',
    specs: ['150cc Engine', 'Electric Start', 'Adjustable Seats']
  },
  {
    id: 6,
    category: 'Mahindra Tractors',
    ...
    price: '$24,900',
    status: 'Incoming',
    image: '/inventory/mahindra_4540.png',
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className={`w-2 h-2 rounded-full ${isSyncing ? 'bg-amber-500 animate-spin' : 'bg-green-500 animate-pulse'}`} />
              <span className="text-sm font-bold text-slate-500 uppercase tracking-wider">
                {isSyncing ? 'Syncing with Lizzie POS...' : `Lizzie POS Sync Active (Last: ${lastSynced})`}
              </span>
              {!isSyncing && (
                <button
                  onClick={handleSync}
                ...
                >
                  <RefreshCw className="w-3.5 h-3.5 text-slate-400 group-hover:text-red-600 transition-colors" />
                </button>
              )}
            </div>
