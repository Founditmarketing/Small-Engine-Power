  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-red-700 transition-transform hover:scale-110 z-50 ${isOpen ? 'scale-0 opacity-0 pointer-events-none invisible' : 'scale-100 opacity-100'}`}
      >
